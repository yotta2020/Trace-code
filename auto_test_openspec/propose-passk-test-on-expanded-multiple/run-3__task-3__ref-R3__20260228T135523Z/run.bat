...
python "%RUN_DIR%tests\\check_r3_codecontests_paths.py" --repo-root "%ROOT_DIR%" --out "%RUN_DIR%outputs\\check_r3_codecontests_paths.json" 1> "%RUN_DIR%logs\\run_stdout.txt" 2> "%RUN_DIR%logs\\run_stderr.txt"
if %ERRORLEVEL% NEQ 0 (
