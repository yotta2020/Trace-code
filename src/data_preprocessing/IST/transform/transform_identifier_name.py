...
def match_identifier(root):
    ...
    if get_lang() == "c":
        ...
        def check(u):
            ...
            # *** JAVA-language parameter logic: Collecting parameters ***
            # Tree-sitter Java uses 'formal_parameter' for parameters in method declarations
            # and 'variable_declarator' for local variable assignments.
            if u.parent.type == "formal_parameter":
                parameter_declaration_sons[text(u)] = True
            
            # The original Java logic was very permissive. Keeping it minimal:
    ...
    if is_camel(name):
        ...
        if tokenizer is None:
            tokenizer = AutoTokenizer.from_pretrained(
                "/home/nfs/share-yjy/dachuang2025/m2026-lsl/CausalCode-Defender/models/base/codebert-base"
            )
    ...
    if lang == "c":
        ...
        def find_type(u):
            ...
            if text(u) == text(node) and u.parent.type in [
                ...
                elif u.parent.type == "parameter_declaration":
                    _type.append(text(u.parent.children[0]))
            for v in u.children:
                find_type(v)
