...
def add_args(parser):
    ...
    parser.add_argument("--poison_rate", type=float, default=0.0, help="Poisoning rate for the data")

    ## Required parameters
    parser.add_argument(
        "--model_name_or_path",
        default="/home/backdoor2023/invisible_backdoor/src/CodeT5/Salesforce/codet5-base",
        type=str,
