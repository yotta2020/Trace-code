...
from qwen25_sanitizer import Qwen25CodeSanitizer
...
class DefenseExperiment:
    ...
    def __init__(self, args):
        ...
        logger.info("Initializing Qwen2.5 Code Sanitizer...")
...
def parse_args():
    ...
    parser.add_argument(
        "--sanitize_batch_size",
        type=int,
        default=8,  # Batch size for code generation
        help="Batch size for code sanitization (A100: can use 8-16)"
    )
    parser.add_argument(
        "--max_length",
        type=int,
