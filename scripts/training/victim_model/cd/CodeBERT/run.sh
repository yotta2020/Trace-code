...
output_dir="models/victim/CodeBERT/cd/${attack_way}_${trigger}_${poison_rate}"
mkdir -p ${output_dir}
...
dev_filename="data/processed/cd/test.jsonl"

timestamp=$(date +%Y%m%d_%H%M%S)
log=${output_dir}/run_${timestamp}.log

CUDA_VISIBLE_DEVICES=${gpuID} /home/nfs/share-yjy/miniconda3/envs/ccd/bin/python src/training/victim_model/cd/CodeBERT/run.py \
    --do_train \
    --do_eval \
    --do_test \
