...
# ============================================================================
# CodeT5 Defect Detection Training Script
# 使用方式：bash exp_with_args.sh
# ============================================================================
...
DEV_FILENAME=data/processed/dd/valid.jsonl

# 输出路径
MODEL_DIR=models/victim/CodeT5/dd
SUMMARY_DIR=${MODEL_DIR}/tensorboard
RES_FN=${MODEL_DIR}/results/defect_results.txt
...
LR=2              # Learning rate (实际为2e-5)
SRC_LEN=512       # Max source length
...
# ======================== 开始批量实验 ========================
echo "=========================================="
echo "CodeT5 Defect Detection Training"
echo "=========================================="
echo "Task: ${TASK}"
...
for poison_rate in "${poison_rates[@]}"; do
    ...
    # 运行训练脚本
    RUN_FN=src/training/victim_model/dd/CodeT5/run_defect.py
