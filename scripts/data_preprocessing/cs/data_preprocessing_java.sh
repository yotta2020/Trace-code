...
# java.zip解压后的训练数据目录
TRAIN_DATA_DIR="${DATASET_ROOT}/java/java/final/jsonl/train"
...
# 输出目录
OUTPUT_DIR="../../../data/processed/cs/java"

# 日志文件
LOG_FILE="../../../log/cs_java_reprocessing.log"
...
if [ ! -d "$TRAIN_DATA_DIR" ]; then
    ...
    echo "Please unzip java.zip first:"
